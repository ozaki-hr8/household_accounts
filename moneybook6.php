<!DOCTYPE html>
  ...
  <body>
    <?php
        ...
        $rest=$allmoney+$income-$finalmoney-$expense-$want1ex-$want2ex;
        $other=$allmoney+$income-$finalmoney-$expense-$food-$dn-$want1ex-$want2ex;
        $wallet=$allmoney;
    ?>
    <?php
   // タイムゾーンを設定
...
<div class="mainarea">
  ...
  <?php
    ...
    $sql='INSERT INTO moneybook_user(date,allmoney,income,food,dn,expense,finalmoney,want1date,want1,want1ex,want2date,want2,want2ex,rest,other,wallet)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
